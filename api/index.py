...
async def send_multiple_requests(uid, server_name, url):
    try:
        ...
        if tokens is None:
            ...
            return 0
        num_requests = min(100, len(tokens))
        tasks = []
        ...
        app.logger.info(f"Successful like requests: {successful}")
        return successful
    except Exception as e:
...
def handle_requests():
    ...
    try:
        def process_request():
            ...
            successful_sent = asyncio.run(send_multiple_requests(uid, server_name, url))
            ...
            result = {
                ...
                "UID": player_uid,
                "status": status,
                "SuccessfulRequests": successful_sent
            }
            return result
