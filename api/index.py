...
# Fixed function name - was enc_uid in original code, changed to enc
def fetch_player_info(encrypted_uid, server, token):
    return make_request(encrypted_uid, server, token)

# Fixed function name - was send_multiple_likes in original code, changed to send_multiple_requests
async def send_multiple_likes(uid, server, url):
    return await send_multiple_requests(uid, server, url)
